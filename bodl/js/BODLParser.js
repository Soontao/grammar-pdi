...
var literalNames = [ null, null, "'businessobject'", "'to'", "'association'",
...
var symbolicNames = [ null, "BooleanLiteral", "BUSINESSOBJECT", "TO", "ASSOCIATION",
  "ELEMENT", "NODE", "ACTION", "MESSAGE", "RAISES",
  "USING", "IMPORT", "AS", "TEXT", "VALUATION", "MultiLineComment",
  "SingleLineComment", "CustomAnnotationStart", "OpenBracket",
  "CloseBracket", "OpenParen", "CloseParen", "OpenBrace",
  "CloseBrace", "SemiColon", "Comma", "Assign", "QuestionMark",
  "Colon", "Dot", "Plus", "Minus", "BitNot", "Not",
  "Multiply", "Divide", "Modulus", "RightShiftArithmetic",
  "LeftShiftArithmetic", "LessThan", "MoreThan", "LessThanEquals",
  "GreaterThanEquals", "Equals_", "NotEquals", "And",
  "Or", "ARROW", "N", "Identifier", "StringLiteral",
  "DecimalLiteral", "HexIntegerLiteral", "OctalIntegerLiteral",
  "OctalIntegerLiteral2", "BinaryIntegerLiteral", "WhiteSpaces",
  "LineTerminator" ];
...
BODLParser.BooleanLiteral = 1;
BODLParser.BUSINESSOBJECT = 2;
BODLParser.TO = 3;
BODLParser.ASSOCIATION = 4;
BODLParser.ELEMENT = 5;
BODLParser.NODE = 6;
BODLParser.ACTION = 7;
BODLParser.MESSAGE = 8;
BODLParser.RAISES = 9;
BODLParser.USING = 10;
BODLParser.IMPORT = 11;
BODLParser.AS = 12;
BODLParser.TEXT = 13;
BODLParser.VALUATION = 14;
BODLParser.MultiLineComment = 15;
BODLParser.SingleLineComment = 16;
BODLParser.CustomAnnotationStart = 17;
BODLParser.OpenBracket = 18;
BODLParser.CloseBracket = 19;
BODLParser.OpenParen = 20;
BODLParser.CloseParen = 21;
BODLParser.OpenBrace = 22;
BODLParser.CloseBrace = 23;
BODLParser.SemiColon = 24;
BODLParser.Comma = 25;
BODLParser.Assign = 26;
BODLParser.QuestionMark = 27;
BODLParser.Colon = 28;
BODLParser.Dot = 29;
BODLParser.Plus = 30;
BODLParser.Minus = 31;
BODLParser.BitNot = 32;
BODLParser.Not = 33;
BODLParser.Multiply = 34;
BODLParser.Divide = 35;
BODLParser.Modulus = 36;
BODLParser.RightShiftArithmetic = 37;
BODLParser.LeftShiftArithmetic = 38;
BODLParser.LessThan = 39;
BODLParser.MoreThan = 40;
BODLParser.LessThanEquals = 41;
BODLParser.GreaterThanEquals = 42;
BODLParser.Equals_ = 43;
BODLParser.NotEquals = 44;
BODLParser.And = 45;
BODLParser.Or = 46;
BODLParser.ARROW = 47;
BODLParser.N = 48;
BODLParser.Identifier = 49;
BODLParser.StringLiteral = 50;
...
BoActionContext.prototype.annotations = function() {
  return this.getTypedRuleContext(AnnotationsContext, 0);
};
...
MessageContext.prototype.annotations = function() {
  return this.getTypedRuleContext(AnnotationsContext, 0);
};
...
NodeContext.prototype.SemiColon = function() {
  return this.getToken(BODLParser.SemiColon, 0);
};
...
AssociationContext.prototype.identifier = function() {
  return this.getTypedRuleContext(IdentifierContext, 0);
};
...
AssociationContext.prototype.memberExpression = function() {
  return this.getTypedRuleContext(MemberExpressionContext, 0);
};
...
BODLParser.prototype.literal = function() {
  ...
  try {
    ...
    this.state = 345;
    _la = this._input.LA(1);
    if(!(_la === BODLParser.BooleanLiteral || _la === BODLParser.StringLiteral || _la === BODLParser.DecimalLiteral)) {
      this._errHandler.recoverInline(this);
    } else {
        	this._errHandler.reportMatch(this);
      this.consume();
...
BODLParser.prototype.compareOperator = function() {
  ...
  try {
    ...
    this.state = 353;
    _la = this._input.LA(1);
    if(!(((((_la - 39)) & ~0x1f) == 0 && ((1 << (_la - 39)) & ((1 << (BODLParser.LessThan - 39)) | (1 << (BODLParser.MoreThan - 39)) | (1 << (BODLParser.LessThanEquals - 39)) | (1 << (BODLParser.GreaterThanEquals - 39)) | (1 << (BODLParser.Equals_ - 39)) | (1 << (BODLParser.NotEquals - 39)))) !== 0))) {
      this._errHandler.recoverInline(this);
    } else {
        	this._errHandler.reportMatch(this);
      this.consume();
